...
wk.add({
  ...
  { "<TAB>lr",  vim.lsp.buf.rename,                                        desc = "Rename symbol" },
  { "<TAB>la",  vim.lsp.buf.code_action,                                   desc = "Code action" },
  ...
  { "<TAB>lK",  ":Trouble lsp_type_definitions toggle focus=true<cr>",     desc = "Type definitions" },
  ...
  { "<TAB>a",   group = "Claude Code" },
  { "<TAB>at",  ":ClaudeCode<cr>",                                         desc = "Toggle Claude Code terminal" },
  { "<TAB>aa",  ":ClaudeCodeAdd %<cr>",                                    desc = "Add current file to context" },
...
wk.add({
  {
    ...
    { "<TAB>c",  group = "Copilot" },
    { "<TAB>a",  group = "Claude Code" },
    { "<TAB>as", ":ClaudeCodeSend<cr>",          desc = "Send selection to Claude Code" },
    { "<TAB>aa", ":ClaudeCodeAdd<cr>",            desc = "Add selection to Claude context" },
