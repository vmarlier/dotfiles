    ...
    opts = function()
        ...
        if handle then
          for dir in handle:lines() do
            ...
            if repo_name then
              ...
              local item_action = string.format(":lua vim.cmd('cd %s'); Snacks.explorer();",
                trimmed_dir)
      ...
      local config = {
        ...
        items = {
          ...
          { name = "Dotfiles", action = ":lua vim.cmd('cd ~/Git/valentin.marlier/dotfiles'); Snacks.explorer();", section = 'Perso' },
          pleo_repo,
