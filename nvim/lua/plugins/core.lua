    ...
    { -- Starter screen
        ...
        opts = function()
                    ...
                    for dir in handle:lines() do
                        ...
                        if repo_name then
                            ...
                            local item_action = string.format(
                                ":lua require('mini.starter').close(); vim.cmd('cd %s');",
                                trimmed_dir)
            ...
            local config = {
                ...
                items = {
                    { name = "Dotfiles",     action = ":lua require('mini.starter').close(); vim.cmd('cd ~/Git/valentin.marlier/dotfiles');",     section = 'Perso' },
                    { name = "Dummy-tester", action = ":lua require('mini.starter').close(); vim.cmd('cd ~/Git/valentin.marlier/dummy-tester');", section = 'Perso' },
                    pleo_repo,
